setwd("~/Dropbox/alignment/Skin_new")


library(Seurat)
library(Signac)

skin=readRDS('~/Dropbox/Multiome_Shared/data/share_seq/skin/skin.frag.rds')
...
# see 3_rna_atac_relationship_1.r
...
saveRDS(skin, file='~/Dropbox/Multiome_Shared/data/share_seq/skin/skin.chromvar.rds')
