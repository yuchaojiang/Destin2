# share_seq_skin_frag.R

rm(list=ls())
setwd('~/Dropbox/alignment/ATAC_RNA/')
# setwd('~/Documents/uncch/jiang_lab/project_alignment/ATAC_RNA')

# dir.out <- "~/Dropbox/alignment/ATAC_RNA/output_yuriko/"
# if (!exists(dir.out)) dir.create(dir.out)
dir.fig <- "~/Dropbox/alignment/ATAC_RNA/figures_yuriko/"
# if (!exists(dir.fig)) dir.create(dir.fig)
# dir.out <- "~/Dropbox/jiang_lab/project_alignment/data/data_035/"
# if (!exists(dir.out)) dir.create(dir.out)
# dir.fig <- "~/Dropbox/jiang_lab/project_alignment/data/fig_035/"
# if (!exists(dir.fig)) dir.create(dir.fig)

# dir.data <- "~/Dropbox/alignment/ATAC_RNA/data_yuriko/"
dir.out <- "~/Dropbox/alignment/ATAC_RNA/data_yuriko/"
dir.in <- "~/Dropbox/Multiome_Shared/data/share_seq/skin/"
