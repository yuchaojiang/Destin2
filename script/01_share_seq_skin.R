# srun -t 1:00:00 --mem 10000 -p interact -N 1 -n 1 --pty /bin/bash
# module load r/4.0.1
# module load gcc/6.3.0
# R
# .libPaths("~/yuchaojlab/yuchaoj/multiomics/rprogramme")
# .libPaths()
...
setwd("/proj/yuchaojlab/yuchaoj/multiomics")
.libPaths("~/yuchaojlab/yuchaoj/multiomics/rprogramme")
.libPaths()
...
# https://satijalab.org/signac/articles/skin_vignette.html
DefaultAssay(skin) <- "ATAC"
...
# https://satijalab.org/signac/articles/skin_vignette.html
# If we have the fragment file, it should be as simple as
...
setwd("~/Dropbox/Multiome_Shared/data/share_seq/skin")
